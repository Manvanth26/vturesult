...
<lable>External marks</lable>
<input type="text" name="marks[]" class="form-control" id="marks" value="<?php echo htmlentities($result->marks)?>" maxlength="20" required="required" autocomplete="off">
<lable>Internal marks</lable>
<input type="text" name="intmarks[]" class="form-control" id="marks" value="<?php echo htmlentities($result->internalmarks)?>" maxlength="20" required="required" autocomplete="off">
</div>
</div>
