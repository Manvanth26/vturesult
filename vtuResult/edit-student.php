...
$dob=$_POST['dob']; 
$status=$_POST['status'];
$sql="update tblstudents set StudentName=:studentname,RollId=:roolid,StudentEmail=:studentemail,Gender=:gender,DOB=:dob,Status=:status,ClassId=:ClassId where StudentId=:stid ";
...
{   
    if($result->ClassId == $result1->id)  
    {
     
?>
<option selected value="<?php echo htmlentities($result1->id); ?>"><?php echo htmlentities($result1->ClassName); ?>&nbsp; Section-<?php echo htmlentities($result1->Section); ?></option>
...
<option value="<?php echo htmlentities($result1->id); ?>"><?php echo htmlentities($result1->ClassName); ?>&nbsp; Section-<?php echo htmlentities($result1->Section); ?></option>
