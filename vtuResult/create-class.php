                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form method="post">
                                                    <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                                			<input type="text" name="classname" pattern="^(?=[a-zA-Z]{3,30}$)(?!.*[_.]{2})[^_.].*[^_.]$" title="Pattern Not Matching Minimum 3 hcaractes should be their and numbers not allowed" class="form-control" required="required" id="success">
                                                		</div>
                                                	</div>
                                                       <!-- <div class="form-group has-success">
