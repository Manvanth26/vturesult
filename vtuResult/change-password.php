    ...
    <div class="alert alert-danger left-icon-alert" role="alert">
                                    ...
                                    <input type="password" name="password" class="form-control" required="required" id="success">
                                                       ...
                                                       <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            <input type="password" title="Password should contain At least 1 Uppercase, At least 1 Lowercase,At least 1 Number,At least 1 Symbol,Min 8 chars and Max 12 chars " pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,12}$" name="newpassword" required="required" class="form-control" id="success">
                                                        </div>
                                                    </div>
                                                     <div class="form-group has-success">
                                                        <label for="success" class="control-label">Confirm Password</label>
                                                        <div class="">
                                                            <input type="password" title="Password should contain At least 1 Uppercase, At least 1 Lowercase,At least 1 Number,At least 1 Symbol,Min 8 chars and Max 12 chars " pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,12}$" name="confirmpassword" class="form-control" required="required" id="success">
                                                        </div>
                                                    </div>
  <div class="form-group has-success">
