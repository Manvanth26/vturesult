...
$sql="update  tblsubjects set SubjectName=:subjectname,SubjectCode=:subjectcode,creditscore=:creditscore where id=:sid";
...
<div class="form-group">
 ...
 <input type="text" name="subjectcode" class="form-control" value="<?php echo htmlentities($result->SubjectCode);?>"  id="default" placeholder="Subject Code" required="required">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
 <input type="text" name="creditscore" class="form-control" id="default"  value="<?php echo htmlentities($result->creditscore);?>"  placeholder="Credit Score" required="required">
                                                        </div>
                                                    </div>
